...
const GREETER_CONTRACT_ADDRESS = "0x563c8F57ba61593f7f965C193D803520B991AD2b"; // TODO: Add smart contract address
// eslint-disable-next-line
...
export default {
  ...
  methods: {
    initializeProviderAndSigner() {
      this.provider = new Provider('http://localhost:3050');
